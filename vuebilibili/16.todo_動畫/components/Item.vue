<template>
    <transition name="ItemAnimate" appear>
      <li>
      <label>
...
<style scoped>
  ...
  .ItemAnimate-enter-active{
    animation: ItemAnimate 0.5s linear;
  }
  .ItemAnimate-leave-active{
    animation: toItemAnimatedo 0.5s linear reverse;
  }
